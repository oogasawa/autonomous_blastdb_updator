...
# Refseq rna
mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/archaea
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/archaea/archaea.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/archaea

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/bacteria
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/bacteria/bacteria.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/bacteria

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/fungi
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/fungi/fungi.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/fungi

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/invertebrate
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/invertebrate/invertebrate.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/invertebrate

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/mitochondrion
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/mitochondrion/mitochondrion.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/mitochondrion

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/other
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/other/other.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/other

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/plant
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/plant/plant.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/plant

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/plasmid
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/plasmid/plasmid.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/plasmid

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/plastid
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/plastid/plastid.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/plastid

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/protozoa
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/protozoa/protozoa.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/protozoa

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/vertebrate_mammalian
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/vertebrate_mammalian/vertebrate_mammalian.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/vertebrate_mammalian

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/vertebrate_other
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/vertebrate_other/vertebrate_other.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/vertebrate_other

mkdir -p ${DEST_DATASET_DIR}/na/refseq/fasta/release/viral
cp -p ${SRC_DATASET_DIR}/na/refseq/fasta/release/viral/viral.1.1.rna.fna.gz ${DEST_DATASET_DIR}/na/refseq/fasta/release/viral
